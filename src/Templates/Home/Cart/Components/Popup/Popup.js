...
function PopupPro({productId, price, name, description, updateCart, deleteCart, stock}){
    let cart_popup_newQuantity = 1;
    return (
        <div>
        {/* <!-- Modal --> */}
        <div className="modal fade" id={"popupprocart"+productId} tabIndex="-1" role="dialog">
        <div className="modal-dialog modal-lg" role="document">
            ...
            <div className="home-cart-k-container">
                <table className="table-sm table-borderless col-md-6">
                    <tbody>
                        ...
                        <div className='home-cart-k-field'><select onChange={(event) => cart_popup_newQuantity=parseInt(event.target.value)} className="form-control" id={"quantity"+productId}>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
            ...
            <div className="mt-4">
                ...
                <li className="nav-item">
                    <p className="nav-link active" data-toggle="tab" data-target={"#description"+productId} role="tab">Description</p>
                </li>
                <li className="nav-item">
                ...
                <div className="tab-content">
                    <div className="tab-pane active" id={"description"+productId} role="tabpanel">{description}</div>
                    <div className="tab-pane text-center" id={"specs"+productId} role="tabpanel">No Specs available for this product at the moment.</div>
                    <div className="tab-pane text-center" id={"review"+productId} role="tabpanel">Not available for this product at the moment.</div>
                </div>
            </div>
            </div>
            <div className="modal-footer">
                ...
                <button type="button" className="btn btn-primary" onClick={() => {updateToast();updateCart({_id:productId, quantity:cart_popup_newQuantity})}} data-dismiss="modal">Save Changes</button>
            </div>
            </div>
        </div>
        </div>
